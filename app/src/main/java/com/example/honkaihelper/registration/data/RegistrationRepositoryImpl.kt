...
class RegistrationRepositoryImpl @Inject constructor(
    ...
    override suspend fun register(login: String, password: String): Result<RegistrationResponse> {
        return withContext(ioDispatcher) {
            handleApi { registrationService.registration(RegistrationRequest(login, password)) }
        }
    }
}