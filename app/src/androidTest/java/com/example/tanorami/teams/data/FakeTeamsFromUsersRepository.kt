...
class FakeTeamsFromUsersRepository @Inject constructor() : TeamsFromUsersRepository {
    override suspend fun getTeamsListByID(idHero: Int): com.example.data.remote.NetworkResult<List<TeamHeroes>> {
        return com.example.data.remote.NetworkResult.Success(emptyList())
    }

    override suspend fun getTeamsList(): com.example.data.remote.NetworkResult<List<TeamHeroes>> {
        return com.example.data.remote.NetworkResult.Success(emptyList())
    }
